export default function ContactSection() {
  return (
    <section className="py-20 md:py-28 px-6 bg-white text-black min-h-screen flex flex-col pt-24">
      ...
      {/* Footer */}
      <footer className="mt-16 pt-16 pb-8 bg-gray-900 text-xs text-gray-400">
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <button
              ...
              className="w-10 h-10 bg-red-500 text-white rounded-full flex items-center justify-center hover:bg-black transition-colors"
            >
              ↑
            </button>
          </div>
